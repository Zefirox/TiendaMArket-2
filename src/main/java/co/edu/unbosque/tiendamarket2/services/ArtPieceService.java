...
public class ArtPieceService {
    ...
    public Optional<Boolean> createArt(String username, String title, String price, String image, String path) throws IOException {
        try{
            String newLine = username+ "," +title+ "," +price + "," + image+"\n";
